...
object test {
  def main(args: Array[String]): Unit = {
    case class col(s1:String,s2:String,s3:String,s4:String,s5:String,s6:String,s7:String)
  ...
  val schema=col(s1,s2,s3,s4,s5,s6,s7)
  val datatype=Type(t1,t2,t3,t4,t5,t6,t7)
